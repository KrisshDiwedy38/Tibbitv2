...
export default function ReportBugModal({ isOpen, onClose }: ReportBugModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const endpoint = isProd ? "/api/users/report-bug/" : `${apiUrl || "http://localhost:8000"}/api/users/report-bug/`;
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-8 sm:p-12 md:p-16">
      ...
      {/* Modal Content */}
      <div className="relative w-full max-w-md bg-[#ff3333] border-4 border-black p-5 sm:p-8 neo-shadow-primary animate-in fade-in zoom-in duration-200">
        <button
          onClick={onClose}
        ...
        {toastState && (
          <div className="absolute inset-0 bg-[#ff3333] flex flex-col items-center justify-center text-center p-8 border-4 border-black animate-in fade-in slide-in-from-bottom-4 duration-300">
            ...
            <p className="font-bold opacity-90 mt-2 text-white">
